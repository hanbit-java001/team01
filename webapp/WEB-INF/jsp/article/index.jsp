		...
		<div class="container">
			...
			<div class="content">
				...
				<div class="grid">
					...
					<figure class="effect-lily">
						<img src="/static/img/1.jpg" alt="img1"/>
						<figcaption>
							<div>
								<h2>Nice <span>Lily</span></h2>
								<p>Lily likes to play with crayons and pencils</p>
				...
				<div class="grid">
					<figure class="effect-sadie">
						<img src="/static/img/2.jpg" alt="img02"/>
						<figcaption>
					...
					<figure class="effect-sadie">
						<img src="/static/img/14.jpg" alt="img14"/>
						<figcaption>
							<h2>Holy <span>Sadie</span></h2>
							<p>Sadie never took her eyes off me. <br>She had a dark soul.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					<figure class="effect-honey">
						<img src="/static/img/4.jpg" alt="img04"/>
						<figcaption>
				...
				<div class="grid">
					<figure class="effect-marley">
						<img src="/static/img/11.jpg" alt="img11"/>
						<figcaption>
				...
				<div class="grid">
					<figure class="effect-ruby">
						<img src="/static/img/13.jpg" alt="img13"/>
						<figcaption>
				...
				<div class="grid">
					<figure class="effect-roxy">
						<img src="/static/img/15.jpg" alt="img15"/>
						<figcaption>
				...
				<div class="grid">
					<figure class="effect-dexter">
						<img src="/static/img/19.jpg" alt="img19"/>
						<figcaption>
