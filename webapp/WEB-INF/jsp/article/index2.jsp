			...
			<div class="content">
				...
				<div class="grid">
					<figure class="effect-julia">
						<img src="/static/img/21.jpg" alt="img21"/>
						<figcaption>
					...
					<figure class="effect-julia">
						<img src="/static/img/22.jpg" alt="img22"/>
						<figcaption>
							<h2>Passionate <span>Julia</span></h2>
							<div>
								<p>Julia dances in the deep dark</p>
				...
				<div class="grid">
					<figure class="effect-hera">
						<img src="/static/img/17.jpg" alt="img17"/>
						<figcaption>
					...
					<figure class="effect-hera">
						<img src="/static/img/25.jpg" alt="img25"/>
						<figcaption>
							<h2>Tender <span>Hera</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-file-pdf-o"></i></a>
				...
				<div class="grid">
					<figure class="effect-winston">
						<img src="/static/img/30.jpg" alt="img30"/>
						<figcaption>
					...
					<figure class="effect-winston">
						<img src="/static/img/1.jpg" alt="img01"/>
						<figcaption>
							<h2>Jolly <span>Winston</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-star-o"></i></a>
				...
				<div class="grid">
					<figure class="effect-selena">
						<img src="/static/img/10.jpg" alt="img10"/>
						<figcaption>
					...
					<figure class="effect-selena">
						<img src="/static/img/31.jpg" alt="img31"/>
						<figcaption>
							<h2>Happy <span>Selena</span></h2>
							<p>Selena is a tiny-winged bird.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					<figure class="effect-terry">
						<img src="/static/img/16.jpg" alt="img16"/>
						<figcaption>
					...
					<figure class="effect-terry">
						<img src="/static/img/26.jpg" alt="img26"/>
						<figcaption>
							<h2>Noisy <span>Terry</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-download"></i></a>
				...
				<div class="grid">
					<figure class="effect-phoebe">
						<img src="/static/img/3.jpg" alt="img03"/>
						<figcaption>
					...
					<figure class="effect-phoebe">
						<img src="/static/img/7.jpg" alt="img07"/>
						<figcaption>
							<h2>Plain <span>Phoebe</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-user"></i></a>
				...
				<div class="grid">
					<figure class="effect-apollo">
						<img src="/static/img/18.jpg" alt="img18"/>
						<figcaption>
				...
				<div class="grid">
					...
					<figure class="effect-kira">
						<img src="/static/img/5.jpg" alt="img05"/>
						<figcaption>
							<h2>Dark <span>Kira</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-home"></i></a>
				...
				<div class="grid">
					<figure class="effect-steve">
						<img src="/static/img/29.jpg" alt="img29"/>
						<figcaption>
					...
					<figure class="effect-steve">
						<img src="/static/img/33.jpg" alt="img33"/>
						<figcaption>
							<h2>Lonely <span>Steve</span></h2>
							<p>Steve was afraid of the Boogieman.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					...
					<figure class="effect-moses">
						<img src="/static/img/20.jpg" alt="img20"/>
						<figcaption>
							<h2>Cute <span>Moses</span></h2>
							<p>Moses loves to run after butterflies.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					...
					<figure class="effect-jazz">
						<img src="/static/img/6.jpg" alt="img06"/>
						<figcaption>
							<h2>Dynamic <span>Jazz</span></h2>
							<p>When Jazz starts to chase cars, the whole world stands still.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					<figure class="effect-ming">
						<img src="/static/img/9.jpg" alt="img09"/>
						<figcaption>
					...
					<figure class="effect-ming">
						<img src="/static/img/8.jpg" alt="img08"/>
						<figcaption>
							<h2>Funny <span>Ming</span></h2>
							<p>Ming sits in the corner the whole day. She's into crochet.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					<figure class="effect-lexi">
						<img src="/static/img/12.jpg" alt="img12"/>
						<figcaption>
				...
				<div class="grid">
					<figure class="effect-duke">
						<img src="/static/img/27.jpg" alt="img27"/>
						<figcaption>
